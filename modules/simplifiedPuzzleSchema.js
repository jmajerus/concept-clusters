...
export const LARGE_DESCRIPTION =
  "Derived from node count on save; omit. True when total nodes (cluster terms plus bridges) exceed 16 so the puzzle uses the larger board. Do not set or clear this to change canvas size, and do not drop a distinct term to stay on the standard board. Split into relatedPuzzles only above 25.";
