...
| `draftReviewPage.js` | HTML for `/admin/drafts`: publish-path status (working copy / authoring play / freeze gate), GitHub production, Publish, Cue/Hold, local Open board / Play, leftover Uninstall, and New puzzle | `stagingPlayLinks.js`, `puzzles/categories.js`, `authoringAdminIndex.js` |
