...
form. Drafts HTML stays a prose ledger plus Publish, Publish & Cue, Cue, and
Hold. Publish leaves the editor open; Cue means “I’m done with this” and
returns to the puzzle list, while Publish & Cue combines both operations and
also returns to the list. Hold leaves the editor open. Freeze is on `/admin`.
MCP stays optional assistance on the same D1 document.
