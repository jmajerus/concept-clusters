/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.authoring.jsonc src/authoring-worker-configuration.d.ts` (hash: 6dacc92f68b802fe31337549a7c6c7cb)
// Runtime types generated with workerd@1.20260730.1 2026-08-02 nodejs_compat
interface __BaseEnv_Env {
	AUTHORING_DB: D1Database;
	AUTHORING_HOSTNAME: "concept-clusters-authoring.jmajerus.workers.dev";
	AUTHORING_DEV_SUBJECT: "local-author";
	TEAM_DOMAIN: "https://linkbud.cloudflareaccess.com";
	POLICY_AUD: "ae4fd234734e3fe37f8d4231dda427bf66c2fb84efafae2be46c79c7b350a5d7";
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./authoring-worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTHORING_HOSTNAME" | "AUTHORING_DEV_SUBJECT" | "TEAM_DOMAIN" | "POLICY_AUD" | "GITHUB_OWNER" | "GITHUB_REPOSITORY" | "GITHUB_BASE_BRANCH" | "GITHUB_TOKEN">> {}
}
declare module "*.md" {
	const value: string;
