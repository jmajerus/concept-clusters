/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.authoring.jsonc src/authoring-worker-configuration.d.ts` (hash: fbcffaebc19b4c5c9e8becc25028574e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTHORING_HOSTNAME" | "AUTHORING_DEV_SUBJECT" | "TEAM_DOMAIN" | "POLICY_AUD">> {}
}
declare module "*.md" {
	const value: string;
