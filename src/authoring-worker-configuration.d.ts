/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.authoring.jsonc src/authoring-worker-configuration.d.ts` (hash: e801bf82059ed0e2004e6968f7a6d306)
