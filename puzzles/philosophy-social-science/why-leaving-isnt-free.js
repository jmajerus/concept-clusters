// Generated from content/puzzles/why-leaving-isnt-free.ccpuzzle.jsonld.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "cluster-friction",
      "name": "Why leaving isn't free",
      "color": "teal",
      "fact": "The textbook model of a labor market assumes any worker paid less than they could earn elsewhere quits immediately. Manning's book is built on noticing how rarely that happens. Finding a comparable job, confirming it actually pays more, and absorbing the disruption of a move all take time and carry risk -- and until all of that is done, the wage cut that should have triggered an exodus mostly does not.",
      "terms": [
        "search frictions",
        "mobility costs",
        "imperfect information"
    ...
    {
      "id": "cluster-room",
      "name": "The room this buys an employer",
      "color": "blue",
      "fact": "Every one of these frictions translates into something an employer can measure, whether or not any employer sits down to calculate it. Labor economists estimate it directly, and the numbers are not small: a widely cited range puts the gap between what workers are paid and what they actually produce at fifteen to fifty percent, entirely attributable to the room frictions create.",
      "terms": [
        "labor supply elasticity",
        "wage markdown",
    ...
    },
    {
      ...
      "name": "Where it lands hardest",
      "color": "amber",
      "fact": "Monopsony is not a uniform tax applied equally to everyone. It concentrates wherever mobility is hardest and alternatives are fewest -- occupations tied to a handful of local employers, workers whose other commitments narrow how far they can realistically move. The same mechanism, measured in different populations, keeps landing on the people who were already least able to walk away.",
      "terms": [
        "gender wage gap",
        "thin markets",
        "quit elasticity"
    ...
    {
      "id": "cluster-textbook",
      "name": "What the textbook gets wrong",
      "color": "magenta",
      "fact": "Manning opens his book with a simple provocation: what happens if an employer cuts wages by one cent? The standard competitive model has an answer, and it is wrong often enough to matter. Once monopsony is taken seriously, several results the textbook treats as settled come out differently -- most consequentially, what a minimum wage actually does to employment.",
      "terms": [
  ...
  "bridges": [
    {
      "id": "bridge-why-the-curve-slopes-up",
      "term": "why the curve slopes up",
      "clusters": [
        0,
        1
      ],
    ...
    {
      "id": "bridge-uneven-friction",
      "term": "the uneven cost of leaving",
      "clusters": [
        0,
        2
      ],
    ...
    {
      "id": "bridge-raising-the-floor",
      "term": "raising the floor",
      "clusters": [
        1,
        3
      ],
