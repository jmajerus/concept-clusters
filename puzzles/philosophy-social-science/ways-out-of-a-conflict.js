// Generated from content/puzzles/ways-out-of-a-conflict.ccpuzzle.jsonld.
...
export default definePuzzle(import.meta.url, {
  ...
  "info": {
    "link": "https://wwnorton.com/books/From-Conflict-to-Resolution",
    "text": "Susan Heitler's framework for conflict resolution therapy, which treats the strategies people use to end conflicts as the same small set whether the conflict is between two people or inside one. The five strategies are Pruitt and Rubin's; the claim that they run inward as well as outward is Heitler's. The book dates from 1990 and its clinical categories reflect that; what has held up is the structural account, which is what this puzzle is built from.",
  ...
  "clusters": [
    {
      ...
      "name": "Fighting",
      "color": "teal",
      "fact": "Contending means trying to impose your preferred solution on the other party -- by insisting, blaming, criticizing, shouting, or force. Heitler's move is to notice that the same strategy runs inward with no second party required. Projection attacks in someone else what a person cannot bear to see in themselves; self-criticism attacks their own thoughts and feelings directly. The target changes. The strategy does not. Two people both contending produces arguments, and can escalate from there.",
      "terms": [
        "blaming",
        "criticizing",
        "projection",
      ...
      "termInfo": {
        "blaming": {
          "text": "Assigning the problem to the other party: 'If you hadn't...' It settles the question of cause before anyone has looked into it."
        },
        "criticizing": {
          "text": "Attacking the person rather than naming what you want: 'Why did you have to...?!'"
        },
        "projection": {
          "text": "Blame and criticism aimed at another person in place of seeing the same quality in oneself. Contending, with a substitute opponent."
        },
        "self-criticism": {
    ...
    },
    {
      ...
      "name": "Yielding",
      "color": "blue",
      "fact": "Yielding lowers your aspirations and settles for less than you would have liked. It ends the conflict immediately and at a cost that is invisible in the moment, because the person paying it is the only one who knows what was on the table. From outside it can look like generosity, flexibility, or an easy temperament, which is part of why it can run for years without anyone naming it.",
      "terms": [
        "giving in",
      ...
      "termInfo": {
        "denying own preferences": {
          "text": "Ceasing to register what you want at all, rather than wanting it and conceding. The version that is hardest to notice from inside."
        },
        "giving in": {
          "text": "Agreeing to what the other party wants, often specifically to end the conflict rather than because you were persuaded."
        },
        "lowering aspirations": {
    ...
    },
    {
      ...
      "name": "Fleeing",
      "color": "amber",
      "fact": "Withdrawing leaves the scene of the conflict -- physically, by ceasing to talk, or by moving the conversation somewhere else. Turned inward it becomes leaving the scene of a thought: denial blocks an uncomfortable reality out of awareness, and obsessional thinking crowds it out with something absorbing and safe. Two people both fleeing produces a household where nothing is ever discussed and nobody can say what is wrong.",
      "terms": [
        "changing the topic",
        "leaving the scene",
        "denial",
      ...
      "termInfo": {
        "changing the topic": {
          "text": "Leaving the conflict without leaving the room. Cheaper than walking out and harder to object to."
        },
        "denial": {
          "text": "Blocking an uncomfortable thought, feeling, or reality out of awareness entirely. Fleeing something you cannot physically walk away from."
        },
        "leaving the scene": {
          "text": "Departing the conflict physically, or cognitively and emotionally while still present."
        },
        "obsessional thinking": {
    ...
    },
    {
      ...
      "name": "Waiting",
      "color": "magenta",
      "fact": "Inaction waits for the other party's next move. It is the hardest of the four to recognise as a strategy, because from inside it feels like not doing anything -- which is exactly what it is, and exactly why it functions as an exit. Nothing is decided and nobody has to decide it. Two parties both waiting produces a negotiation that never concludes and a tension that never resolves.",
      "terms": [
        "procrastination",
        "passivity",
      ...
      "termInfo": {
        "passivity": {
          "text": "Doing nothing in the hope that the situation will improve on its own."
        },
        "procrastination": {
          "text": "The everyday form: the thing that would settle it stays undone, and the not-doing is never quite a decision."
        },
        "waiting for the other's move": {
    ...
    },
    {
      ...
      "color": "olive",
      "fact": "Problem-solving pursues alternatives that satisfy both sides, and Heitler's components of it are all things you could check in a transcript: whether people say what they want, whether they take in what was said, whether airtime and volume run roughly even, and whether anyone ever states back what the two of them have arrived at. Notice what these have in common. Every one of them takes time -- which is the reason the other four keep winning.",
      "terms": [
        "saying what is wanted",
        "receptive listening",
        "symmetry",
      ...
      "termInfo": {
        "receptive listening": {
          "text": "Taking in what the other person said and building on it, rather than continuing your own train of thought or hunting for what is wrong in theirs."
        },
        "saying what is wanted": {
          "text": "Stating your own preference directly, rather than hinting at it, asking about theirs, or naming what you don't want."
        },
        "summarizing statement": {
          "text": "Saying back what the two of you have arrived at, including the part that came from the other person. Its absence is a red flag on its own."
        },
        "symmetry": {
  ...
  "bridges": [
    ...
    {
      "id": "bridge-contradicting",
      "term": "contradicting response",
      "clusters": [
        0,
        4
      ],
    ...
    {
      "id": "bridge-asking",
      "term": "asking instead of stating",
      "clusters": [
        2,
        4
      ],
