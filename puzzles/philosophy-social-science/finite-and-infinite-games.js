  ...
  "clusters": [
    {
      ...
      "name": "Finite play",
      "color": "teal",
      "fact": "A finite game is played inside fixed boundaries, according to agreed rules, for the purpose of reaching a definite end and declaring a winner -- who is then given a title.",
      "terms": [
        "finite game",
        "boundary",
        "rules",
    ...
    {
      "id": "cluster-infinite-play",
      "name": "Infinite play",
      "color": "blue",
      "fact": "An infinite game is played only to keep playing: its rules, its boundaries, and even who's playing are all allowed to change, and its players are known by name, not title, since what they'll do next stays open.",
      "terms": [
        "infinite game",
        "horizon",
        "surprise",
    ...
    {
      "id": "cluster-playing-life",
      "name": "Playing life",
      "color": "amber",
      "fact": "Carse extends the same distinction to how people actually live together: society is organized like a finite game, built on rules and titles, while culture is organized like an infinite game, and the two produce different ways of relating to others, through power or through strength.",
      "terms": [
        "society",
        "culture",
        "power",
