// Generated from content/puzzles/neural-networks-layer-by-layer.ccpuzzle.json.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "cluster-layered-architecture",
      ...
      "termInfo": {
        ...
        "connection weight": {
          ...
          "links": [
            {
              "href": "wiki:Weight (artificial neural network)"
            }
          ]
        }
      }
    ...
    {
      "id": "cluster-forward-computation",
      ...
      "termInfo": {
        ...
        "bias": {
          ...
          "links": [
            {
              "href": "wiki:Bias (machine learning)"
            }
          ]
        },
        "activation function": {
    ...
    {
      "id": "cluster-measuring-prediction-error",
    ...
    {
      "id": "cluster-updating-the-parameters",
      ...
      "termInfo": {
        ...
        "optimizer": {
          ...
          "links": [
            {
              "href": "wiki:Stochastic gradient descent"
            }
          ]
        },
        "learning rate": {
  ...
  "bridges": [
    ...
    },
    {
      ...
      "info": {
        ...
        "links": [
          {
            "href": "wiki:Parameter (statistics)"
          }
        ]
      },
    ...
    },
    {
      ...
      "info": {
        ...
        "links": [
          {
            "href": "wiki:Feedforward neural network"
          }
        ]
      },
      "relationKind": "dynamic",
