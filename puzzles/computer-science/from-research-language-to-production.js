// Generated from content/puzzles/from-research-language-to-production.ccpuzzle.json.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "cluster-establishing-the-idea",
      ...
      "termInfo": {
        "formal semantics": {
          ...
          "links": [
            {
              "href": "wiki:Semantics (computer science)"
            }
          ]
        },
        "soundness argument": {
    ...
    {
      "id": "cluster-supporting-developers",
      ...
      "termInfo": {
        ...
        "documentation": {
          ...
          "links": [
            {
              "href": "wiki:Software documentation"
            }
          ]
        }
      }
    ...
    {
      "id": "cluster-evolving-without-isolation",
      ...
      "termInfo": {
        "foreign-function interface": {
          ...
          "links": [
            {
              "href": "wiki:Foreign function interface"
            }
          ]
        },
        "backward compatibility": {
          ...
          "links": [
            {
              "href": "wiki:Backward compatibility"
            }
          ]
        },
        "versioned editions": {
          ...
          "links": [
            {
              "href": "https://doc.rust-lang.org/edition-guide/editions/"
            }
          ]
        },
        "migration tooling": {
          ...
          "links": [
            {
              "href": "wiki:Software modernization"
            }
          ]
        }
      }
  ...
  "bridges": [
    {
      ...
      "info": {
        ...
        "links": [
          {
            "href": "wiki:Software prototyping"
          }
        ]
      },
    ...
    {
      "id": "bridge-production-readiness",
    ...
    {
      "id": "bridge-implementation-strategy",
    ...
    {
      "id": "bridge-stable-specification",
      ...
      "info": {
        ...
        "links": [
          {
            "href": "wiki:Language specification"
          }
        ]
      },
      "relationKind": "continuity",
