...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "cluster-longinian-elevation",
      "name": "Longinian elevation",
      "color": "teal",
      "fact": "Longinus treats the sublime as a height of language that transports the hearer beyond persuasion, produced chiefly by great conceptions and vehement passion, then by noble diction and dignified composition.",
      "terms": [
        "transport",
        "great conceptions",
        "vehement passion",
    ...
    {
      "id": "cluster-burkean-sublime",
      "name": "Burkean sublime",
      "color": "blue",
      "fact": "Burke locates the sublime in terror, sharpened by obscurity, privation, and vastness, and distinguishes the resulting delight from positive pleasure.",
      "terms": [
        "terror",
        "obscurity",
        "privation",
    ...
    {
      "id": "cluster-kantian-sublime",
      "name": "Kantian sublime",
      "color": "amber",
      "fact": "Kant splits the sublime into mathematical and dynamical modes in which imagination fails to present what reason can think, and the resulting negative pleasure discloses a supersensible vocation.",
      "terms": [
  ...
  "lenses": [
    {
      "id": "longinian-sources",
      "prompt": "Which concepts are Longinus's sources of elevated language, rather than the effect it produces or a neighboring technique?",
      "explanation": "Great conceptions and vehement passion are the innate sources; noble diction and dignified composition are the artistic ones. Transport is the effect those sources produce, not a source. Amplification is a related technique Longinus distinguishes from sublimity itself: without height it is a body without a soul. Figures of thought, the missing third source, are not on the board.",
      "targets": [
        "great conceptions",
        "vehement passion",
        "noble diction",
      ...
      "reasons": {
        "dignified composition": "The fifth source: arrangement and rhythm that bind the others into one lofty movement.",
        "great conceptions": "The first and most powerful source: grandeur of thought.",
        "noble diction": "An artistic source: elevated word choice, metaphor, and elaboration.",
        "vehement passion": "The second source: inspired emotion, which Longinus refuses to collapse into sublimity itself."
      }
    },
    {
      "id": "kantian-modes",
      "prompt": "Which two Kantian modes divide the sublime?",
      "explanation": "Kant divides the Analytic of the Sublime into these two modes: absolute greatness that imagination cannot totalize, and might that has no dominion over us. Negative pleasure, imaginative failure, and the supersensible vocation describe the feeling and the recovery, not the two kinds of encounter. Infinity belongs to the mathematical mode as a shared later term, not as one of Kant's two names.",
      "targets": [
        "mathematical sublime",
        "dynamical sublime"
      ],
      "reasons": {
        "dynamical sublime": "Nature as fearful might contemplated from safety.",
        "mathematical sublime": "Unbounded magnitude that imagination cannot comprehend as a whole."
      }
    },
    {
      "id": "mixed-feeling",
      "prompt": "Which terms name the distinctive feeling of the sublime—a transporting or mixed affective state—rather than the fear, objects, or recovery that surround it?",
      "explanation": "Transport is Longinus's seizure beyond persuasion; astonishment is the shared halt of mind; delight is Burke's tranquillity tinged with terror, explicitly not positive pleasure; negative pleasure is Kant's pleasure that arises only through a check. Terror is the ruling fear that produces Burke's feeling, not the mixed feeling itself. The beautiful is the contrasting pleasure. Supersensible vocation names a recovery, not the feeling.",
      "targets": [
        "transport",
        "astonishment",
        "delight",
      ...
      "reasons": {
        "astonishment": "The halt of ordinary mental motion that Longinus's translators and Burke both use for the sublime's highest pitch.",
        "delight": "Burke's mixed feeling: tranquillity tinged with terror, opposed to positive pleasure.",
        "negative pleasure": "Kant's pleasure that exists only through a momentary displeasure or check.",
        "transport": "Longinus's ekstasis: being seized rather than persuaded."
      }
    }
  ],
  "relatedPuzzles": {
