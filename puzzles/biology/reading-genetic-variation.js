// Generated from content/puzzles/reading-genetic-variation.ccpuzzle.json.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "cluster-describing-sequence-differences",
      ...
      "termInfo": {
        "single-nucleotide variant": {
          "text": "A difference at one nucleotide position relative to a comparison sequence.",
          "links": [
            {
              "href": "wiki:Single-nucleotide variant"
            }
          ]
        },
        "insertion": {
          "text": "One or more nucleotides present in a sequence relative to the selected reference representation.",
          "links": [
            {
              "href": "https://www.genome.gov/genetics-glossary/Insertion"
            }
          ]
        },
        "deletion": {
          "text": "One or more nucleotides absent from a sequence relative to the selected reference representation.",
          "links": [
            {
              "href": "https://www.genome.gov/genetics-glossary/Deletion"
            }
          ]
        },
        "structural variant": {
          "text": "A larger genomic difference, commonly at least 50 bases, such as a deletion, insertion, inversion, duplication, or translocation.",
          "links": [
            {
              "href": "https://www.genome.gov/genetics-glossary/Structural-Variation"
            }
          ]
        }
      }
    ...
    {
      "id": "cluster-collecting-read-evidence",
      ...
      "termInfo": {
        "read alignment": {
          "text": "The placement of sequencing reads against a reference representation to identify likely corresponding positions.",
          "links": [
            {
              "href": "wiki:Sequence alignment"
            }
          ]
        },
        "mapping quality": {
          "text": "A Phred-scaled estimate of confidence that a read has been aligned to the correct reference location.",
          "links": [
            {
        ...
        "allele depth": {
          "text": "The number of reads at a site supporting each observed allele.",
          "links": [
            {
              "href": "https://samtools.github.io/hts-specs/VCFv4.5.pdf"
            }
          ]
        }
      }
    ...
    {
      "id": "cluster-inferring-and-filtering-genotypes",
      ...
      "termInfo": {
        "variant caller": {
          "text": "Software that uses sequencing evidence and a statistical model to identify candidate variants and often infer genotypes.",
          "links": [
            {
              "href": "https://www.ebi.ac.uk/training/materials/genome-bioinformatics-resequencing-and-variant-calling-materials"
            }
          ]
        },
        "genotype likelihood": {
          "text": "The probability of the observed sequencing evidence under each candidate genotype, expressed directly or on a log scale.",
          "links": [
            {
              "href": "https://samtools.github.io/hts-specs/VCFv4.5.pdf"
            }
        ...
        "genotype quality": {
          "text": "A Phred-scaled estimate of confidence in the genotype assigned to a sample at a site.",
          "links": [
            {
              "href": "https://samtools.github.io/hts-specs/VCFv4.5.pdf"
            }
        ...
        "call filter": {
          "text": "A recorded criterion or model decision used to flag candidate calls that do not meet evidence or quality requirements.",
          "links": [
            {
              "href": "https://samtools.github.io/hts-specs/VCFv4.5.pdf"
            }
    ...
    {
      "id": "cluster-interpreting-possible-significance",
      ...
      "termInfo": {
        "allele frequency": {
          "text": "The proportion of sampled chromosome copies carrying a particular allele in a population or dataset.",
          "links": [
            {
        ...
        "predicted consequence": {
          "text": "An annotation of how a variant may intersect a gene, transcript, regulatory feature, or protein sequence.",
          "links": [
            {
              "href": "https://www.ebi.ac.uk/training/online/courses/ensembl-variant-effect-predictor-vep/"
            }
          ]
        },
        "phenotype evidence": {
          "text": "Observations connecting a genotype with traits, clinical findings, or segregation patterns in individuals or families.",
          "links": [
            {
              "href": "wiki:Phenotype"
            }
        ...
        "classification": {
          "text": "A conclusion, such as benign, uncertain, or pathogenic in a clinical setting, assigned according to a defined evidence framework.",
          "links": [
            {
  ...
  "bridges": [
    {
      ...
      "info": {
        "text": "An accepted sequence representation used as a coordinate framework and comparison baseline for genomic analyses.",
        "links": [
          {
            "href": "https://www.genome.gov/genetics-glossary/human-genome-reference-sequence"
          }
        ]
      },
    ...
    },
    {
      ...
      "info": {
        "text": "The allele or combination of alleles inferred for an individual at a genomic location.",
        "links": [
          {
            "href": "https://www.genome.gov/genetics-glossary/genotype"
          }
        ]
      },
    ...
    },
    {
      ...
      "info": {
        "text": "The process of attaching genomic context and evidence, such as affected features or population frequency, to a variant.",
        "links": [
          {
            "href": "wiki:Variant annotation"
          }
        ]
      },
      "relationKind": "evaluation",
    ...
    },
    {
      ...
      "info": {
        "text": "A collection of genome sequences from many individuals of the same species, designed to represent broader genomic diversity.",
        "links": [
          {
            "href": "https://www.genome.gov/genetics-glossary/Pangenome"
          }
        ]
      },
