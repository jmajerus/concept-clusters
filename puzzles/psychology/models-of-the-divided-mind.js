// Generated from content/puzzles/models-of-the-divided-mind.ccpuzzle.json.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "cluster-freudian-structural-metapsychology",
      ...
      "termInfo": {
        "common unhappiness": "Freud's own modest description of the best achievable outcome of therapy: ordinary misery in place of neurotic suffering.",
        "ego defense mechanism": "A strategy the ego uses to reduce anxiety generated by the friction between id, superego, and reality.",
        "id-ego-superego friction": {
          "text": "Freud's structural model of the mind as three agencies in permanent, unresolved negotiation.",
          "links": [
            {
              "href": "wiki:Id, ego and super-ego"
            }
          ]
        },
        "repetition compulsion": {
          ...
          "links": [
            {
              "href": "wiki:Repetition compulsion"
            }
          ]
        },
        "repressed guilt": "Superego-generated guilt kept out of conscious awareness, one of the frictions the ego has to manage."
      },
      "info": {
        "links": [
          {
    ...
    {
      "id": "cluster-jungian-analytical-psychology",
      ...
      "termInfo": {
        ...
        "shadow projection": "Unconsciously attributing one's own rejected traits to someone else."
      },
      "info": {
        "links": [
          {
    ...
    {
      "id": "cluster-mcgowan-s-lacanian-hegelian-critique",
      ...
      "termInfo": {
        "embracing incompleteness": "McGowan's proposed goal, replacing the pursuit of inner peace: accept the split as the site of freedom rather than something to resolve.",
        "ideological refusal": "The political reading of self-sabotage: a subconscious protest against demands for total social harmony.",
        "ontological split": "McGowan's core claim: division is not a malfunction of subjectivity, it is what subjectivity is structurally built from.",
        "radical self-sabotage": "Self-defeating action reinterpreted not as clinical failure but as an unconscious refusal of imposed conformity.",
        "structural alienation": "Where traditional psychology treats alienation as a pain to be cured, McGowan treats it as an inescapable condition."
      },
      "info": {
        "links": [
          {
    ...
    {
      "id": "cluster-capitalist-ideology-commodity-fantasy",
      ...
      "termInfo": {
        "authenticity trap": "The pressure to perform self-actualization through curated presentation -- so even 'being yourself' becomes a product.",
        "commodity cure": "The specific mechanism: persuading someone that a purchase, status marker, or lifestyle choice will patch the internal rift.",
        "compulsory harmony": "A cultural demand for constant positivity that reframes internal conflict or dissatisfaction as personal failure.",
        "consumer identity": "An identity substantially built and maintained through purchase and performance rather than interior integration.",
        "myth of total wholeness": "The foundational promise capitalist ideology sells: that complete inner unity is achievable, and buyable."
      },
      "info": "The promise that the right purchase can close a gap that Freud, Jung, and McGowan all -- in very different ways -- think cannot simply be closed."
    }
  ],
  "bridges": [
    {
