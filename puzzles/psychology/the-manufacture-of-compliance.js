  ...
  "lenses": [
    {
      ...
      "reasons": {
        "the minority who refused": "The dozen who stepped out, unpunished, is the concrete evidence that the option to refuse wasn't just offered -- it was actually survivable to take.",
        ...
        "undiminished responsibility": "The claim only holds because the minority's example proves the choice stayed open the whole time -- nothing about circumstance forced anyone's hand."
      }
    },
    {
      ...
      "reasons": {
        "eroding resistance": "Describes the wearing-down itself: the capacity to refuse diminishes with repetition even though the act's moral weight does not.",
        "escalating commitment": "The sunk-cost logic that makes each act harder to break from the more has already been invested in the pattern -- a separate mechanism from the wearing-down itself.",
        "incremental participation": "Names the specific pattern -- routine, repeated actions replacing a single announced first order -- that makes each subsequent act less of a first time.",
