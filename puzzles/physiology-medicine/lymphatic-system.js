...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      ...
      "termInfo": {
        ...
        "Peyer's patches": {
          "text": "Lymphoid follicles in the small-intestine wall that sample antigen from the gut lumen."
        },
        "bone marrow": {
    ...
    },
    {
      ...
      "termInfo": {
        ...
        "lymphatic capillaries": {
          "text": "Blind-ended, highly permeable vessels that admit interstitial fluid, solutes, and immune cells."
        }
      }
    },
    {
  ...
  "lenses": [
    ...
    },
    {
      ...
      "prompt": "Which concepts carry dietary fat from the gut toward blood?",
      "explanation": "Lacteals absorb fats, chylomicrons ferry them through lymph, and the thoracic duct delivers that fatty lymph to venous blood.",
      "targets": [
        "lacteals",
        "chylomicrons",
        "thoracic duct"
      ...
      "reasons": {
        "lacteals": "They absorb dietary fats from intestinal villi into lymph.",
        "chylomicrons": "They are the particles ferrying absorbed fat through lymph.",
