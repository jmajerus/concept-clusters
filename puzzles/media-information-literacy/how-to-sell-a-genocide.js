// Generated from content/puzzles/how-to-sell-a-genocide.ccpuzzle.json.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "massacre-vs-blast",
      "name": "Massacre vs. Blast",
      "color": "amber",
      ...
      "info": {
        "text": "How the same event earns opposite vocabulary and opposite grammar depending on who is dying and who is responsible.",
        "link": "https://www.currentaffairs.org/news/how-the-media-sold-a-genocide"
      }
    },
    {
      "id": "isis-ification-of-hamas",
      "name": "The ISIS-ification of Hamas",
      "color": "brown",
      ...
      "termInfo": {
        ...
        "the beheaded-babies hoax": {
          ...
          "link": "wiki:Hamas baby beheading hoax"
        },
        "the moral plane of acceptable parties": {
      ...
      "info": {
        "text": "How coverage stripped Hamas of political and historical context to make it read as ahistorical terrorism rather than a domestically rooted movement.",
        "link": "https://www.currentaffairs.org/news/how-the-media-sold-a-genocide"
      }
    },
    {
      "id": "starting-the-clock",
      "name": "Starting the Clock",
      "color": "blue",
      ...
      "info": {
        "text": "How editorial rules about timing and confirmation manufactured distance between Israel and the consequences of its own strikes.",
        "link": "https://www.currentaffairs.org/news/how-the-media-sold-a-genocide"
      }
    },
    {
      ...
      "info": {
        "text": "Who mainstream Sunday shows brought on to explain the war, and the narrow roles the rare Palestinian guest was allowed to occupy.",
        "link": "https://www.currentaffairs.org/news/how-the-media-sold-a-genocide"
      }
    }
  ],
  "bridges": [
    {
      ...
      "fact": "Johnson names the premise underneath both patterns a racist tautology: the assumption that Israel cannot intend to kill innocents while Hamas can only kill for its own sake -- the same circular logic that licenses one people's deaths to be called a massacre and strips the other's of the political context that would make them legible as anything but terrorism.",
      "info": {
  ...
  "learningIntroduction": {
    ...
    "title": "Before You Begin: How to Sell a Genocide",
    "summary": "Context on Adam Johnson's data-driven method for documenting U.S. media bias in coverage of the Gaza war, and why he focuses on liberal rather than right-wing outlets.",
    "estimatedMinutes": 5,
    "content": {
      "mediaType": "text/markdown",
      "text": "## How to sell a genocide\n\nIn October 2023, media critic Adam Johnson and his colleagues began systematically counting things most readers only sense impressionistically: how many times a major outlet called an Israeli death a massacre versus a Palestinian one, how many Palestinian guests appeared on Sunday political shows, how many days an editorial desk waited before naming who dropped a bomb. The resulting book, *How to Sell a Genocide*, argues that a formally free, uncensored press still produced a strikingly one-sided account of the war in Gaza -- not through a conspiracy, but through word choice, timing rules, and decisions about who gets airtime.\n\nJohnson deliberately doesn't spend much time on openly right-wing outlets, which he says never pretended to neutrality on the question. His target is what he calls center-left or liberal media -- the *New York Times*, CNN, MSNBC, the *Washington Post*, *The Atlantic* -- because their claim to be reporting the war fairly is precisely what made their coverage so consequential in sustaining a Democratic administration's support for it.\n\nThe book pairs each pattern with a comparison: the same event described in opposite language depending on who is dying; the same demographic caveat applied to one side's dead and not the other's; the same underlying claim to legitimacy, treated as reasoned protest or as terrorism apologia depending on who's speaking. Johnson himself draws a direct line back to an older argument about how public consent gets manufactured -- the same axioms, he says, just applied faster and more selectively when there's less time for an audience to think something through.\n\n**Before you start:** when a headline says a bomb \"landed\" or a blast \"emerged,\" what work is that sentence doing that a sentence naming who dropped it would not?"
    },
    "sources": [
      {
        "label": "Pluto Press: How to Sell a Genocide",
