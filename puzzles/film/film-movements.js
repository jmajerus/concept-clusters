// Generated from content/puzzles/film-movements.ccpuzzle.jsonld.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      ...
      "color": "teal",
      "fact": "German Expressionist cinema of the 1920s used chiaroscuro lighting, exaggerated shadow, distorted set design, and the Dutch angle to externalize psychological unease rather than depict a naturalistic world.",
      "terms": [
        "chiaroscuro lighting",
        "Dutch angle",
        "distorted set design",
      ...
      "termInfo": {
        ...
        "exaggerated shadow": {
          "text": "Shadow used as a shape in its own right -- painted, cast, or both -- rather than a byproduct of lighting a scene naturally."
        }
      },
      "info": {
    ...
    {
      "id": "cluster-italian-neorealism",
      "name": "Italian Neorealism",
      "color": "blue",
      "fact": "Italian Neorealism turned away from studio artifice after World War II: shooting on real locations, casting non-professional actors, holding a long take rather than cutting away, and centering the everyday hardship of ordinary working people.",
      "terms": [
        "location shooting",
        "non-professional actor",
        "long take",
    ...
    {
      "id": "cluster-french-new-wave",
      "name": "French New Wave",
      "color": "amber",
      "fact": "The French New Wave broke classical convention on purpose: the jump cut interrupted continuity instead of hiding it, handheld camera traded polish for immediacy, direct address acknowledged the audience, and nonlinear narrative abandoned straightforward chronology.",
      "terms": [
        "jump cut",
        "handheld camera",
        "direct address",
  ...
  "bridges": [
    {
      "id": "bridge-studio-artifice",
      "term": "studio artifice",
      "clusters": [
        0,
        1
      ],
    ...
    {
      "id": "bridge-cahiers-du-cinema",
      "term": "Cahiers du cinéma",
      "clusters": [
        1,
        2
      ],
