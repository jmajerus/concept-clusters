// Generated from content/puzzles/where-meaning-comes-from.ccpuzzle.jsonld.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      ...
      "name": "Making and purpose",
      "color": "teal",
      "fact": "Medium, technique, intention, and patronage shape what an artwork could be, why it was made, and which practical or institutional constraints affected its form.",
      "terms": [
        "medium",
        "technique",
        "artist's intention",
    ...
    {
      "id": "cluster-evidence-in-the-work",
      "name": "Evidence in the work",
      "color": "blue",
      "fact": "Title, subject matter, composition, and material evidence provide features against which interpretations can be tested rather than resting only on impression.",
      "terms": [
        "title",
        "subject matter",
        "composition",
    ...
    {
      "id": "cluster-historical-and-cultural-context",
      "name": "Historical and cultural context",
      "color": "amber",
      "fact": "Historical conditions, original setting, cultural conventions, and provenance help explain what a work could signify, how it functioned, and how it moved through systems of ownership and display.",
      "terms": [
        "historical context",
        "original setting",
        "cultural convention",
    ...
    {
      "id": "cluster-reception-and-reinterpretation",
      "name": "Reception and reinterpretation",
      "color": "magenta",
      "fact": "Viewer response, museum labels, critical interpretation, and later reinterpretation show how meaning continues to develop as artworks encounter new audiences and institutions.",
      "terms": [
        "viewer response",
        "museum label",
        "critical interpretation",
  ...
  "bridges": [
    {
      "id": "bridge-formal-evidence",
      "term": "formal evidence",
      "clusters": [
        0,
        1
      ],
    ...
    {
      "id": "bridge-display-context",
      "term": "display context",
      "clusters": [
        2,
        3
      ],
    ...
    {
      "id": "bridge-interpretive-argument",
      "term": "interpretive argument",
      "clusters": [
        1,
        3
      ],
