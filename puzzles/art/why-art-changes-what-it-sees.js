// Generated from content/puzzles/why-art-changes-what-it-sees.ccpuzzle.jsonld.
  ...
  "clusters": [
    {
      ...
      "name": "Pursue resemblance",
      "color": "teal",
      "fact": "Realism, naturalism, likeness, and perspective use different means to make depicted subjects or spaces appear recognizably connected to observed experience.",
      "terms": [
        "realism",
        "naturalism",
        "likeness",
    ...
    {
      "id": "cluster-select-and-simplify",
      "name": "Select and simplify",
      "color": "blue",
      "fact": "Simplification, stylization, abstraction, and geometric reduction remove or reorganize detail so that selected structures and relationships become more prominent.",
      "terms": [
        "simplification",
        "stylization",
        "abstraction",
    ...
    {
      "id": "cluster-intensify-expression",
      "name": "Intensify expression",
      "color": "amber",
      "fact": "Distortion, exaggeration, expressive brushwork, and non-naturalistic color can heighten emotion, energy, emphasis, or subjective experience.",
      "terms": [
        "distortion",
        "exaggeration",
        "expressive brushwork",
    ...
    {
      "id": "cluster-construct-meaning",
      "name": "Construct meaning",
      "color": "magenta",
      "fact": "Symbolism, idealization, memory, and imagination allow artworks to represent values, reconstructed experience, and possibilities that are not reducible to direct observation.",
      "terms": [
        "symbolism",
        "idealization",
        "memory",
