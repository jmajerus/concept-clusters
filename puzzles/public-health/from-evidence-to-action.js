// Generated from content/puzzles/from-evidence-to-action.ccpuzzle.json.
...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      ...
      "termInfo": {
        "case counts": {
          ...
          "links": [
            {
              "href": "wiki:Disease surveillance"
            }
          ]
        },
        "laboratory testing": {
        ...
        "hospital reports": {
          ...
          "links": [
            {
              "href": "wiki:Health information management"
            }
          ]
        },
        "wastewater sampling": {
          ...
          "links": [
            {
              "href": "wiki:Wastewater-based epidemiology"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      "termInfo": {
        ...
        "control group": {
          ...
          "links": [
            {
              "href": "wiki:Treatment and control groups"
            }
          ]
        },
        "risk factor": {
    ...
    },
    {
      ...
      "info": {
        "links": [
          {
            "href": "wiki:Public health intervention"
          }
        ]
      }
    },
    {
      ...
      "termInfo": {
        ...
        "unintended effects": {
          ...
          "links": [
            {
              "href": "wiki:Unintended consequences"
            }
          ]
        },
        "updated guidance": {
          ...
          "links": [
            {
              "href": "wiki:Clinical practice guideline"
            }
          ]
        }
      },
  ...
  "learningIntroduction": {
    ...
    "content": {
      ...
      "text": "# Evidence is not the same as certainty\n\nPublic health asks questions about groups of people: What is changing? Who is affected? What might explain the pattern? Which response is likely to help, and how will we recognize benefits or harms?\n\nEvidence can support each of those judgments, but different evidence answers different questions. A count may show that something happened. A comparison can help test an explanation. Follow-up information can show whether a response worked as expected. None of these automatically makes the next decision certain.\n\n## Four ideas to keep in mind\n\n- **A signal is not yet a cause.** Reports, tests, surveys, and measurements can reveal a pattern while leaving several explanations possible.\n- **Comparisons need context.** Populations may differ in age, exposure, access to care, or how information was collected. A third factor associated with both a suspected cause and an outcome is called a *confounder*.\n- **Interventions involve judgment.** Expected benefit matters, but so do feasibility, proportionality, resources, and effects on the people involved.\n- **Revision can be evidence of learning.** Recommendations should be reconsidered when better information, unexpected effects, or changed conditions become visible.\n\n## A small example\n\nImagine that reports of respiratory illness rise shortly after a community event. The timing is important evidence, but it does not identify the cause by itself. Investigators might compare affected and unaffected groups, consider changes in testing or reporting, examine plausible exposures, and continue collecting information after any response begins.\n\nThe quality of the reasoning depends not only on gathering more facts, but on matching each kind of evidence to the question it can actually answer.\n\n> **Reflection:** When should changing a public recommendation increase rather than decrease your confidence in the decision process?\n"
    },
    "revision": 1
  },
  "provenance": {
