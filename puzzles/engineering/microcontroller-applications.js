// Generated from content/puzzles/microcontroller-applications.ccpuzzle.json.
  ...
  "clusters": [
    {
      ...
      "termInfo": {
        "ADC sampling": {
          ...
          "links": [
            {
              "href": "wiki:Analog-to-digital converter"
            }
          ]
        },
        "sensor polling": {
          ...
          "links": [
            {
              "href": "wiki:Polling (computer science)"
            }
          ]
        },
        "calibration": {
    ...
    },
    {
      ...
      "termInfo": {
        "PWM output": {
          ...
          "links": [
            {
              "href": "wiki:Pulse-width modulation"
            }
          ]
        },
        "motor commutation": {
          ...
          "links": [
            {
              "href": "wiki:Brushless DC electric motor"
            }
          ]
        },
        "feedback control": {
        ...
        "safety interlock": {
          ...
          "links": [
            {
              "href": "wiki:Interlock (engineering)"
            }
          ]
        }
      },
      "info": {
        "links": [
          {
            "href": "https://www.ti.com/technologies/motor-control.html"
          }
        ]
      }
    },
    {
      ...
      "termInfo": {
        "key scanning": {
          ...
          "links": [
            {
              "href": "wiki:Keyboard matrix circuit"
            }
          ]
        },
        "display multiplexing": {
    ...
    {
      "id": "communication-and-persistence",
      ...
      "termInfo": {
        "UART framing": {
          ...
          "links": [
            {
              "href": "wiki:Universal asynchronous receiver-transmitter"
            }
          ]
        },
        "I2C transactions": {
      ...
      "info": {
        "links": [
          {
            "href": "wiki:Serial communication"
          }
        ]
      }
    }
  ...
  "bridges": [
    ...
    },
    {
      ...
      "info": {
        ...
        "links": [
          {
            "href": "wiki:Finite-state machine"
          }
        ]
      },
