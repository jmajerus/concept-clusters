// Generated from content/puzzles/television-landmarks.ccpuzzle.json.
  ...
  "lenses": [
    {
      ...
      "explanation": "Jess Oppenheimer, producer of I Love Lucy, patented an in-camera teleprompter that projected text in front of the lens, allowing performers to appear to look directly toward viewers.",
      "options": [
        {
          "id": "i-love-lucy",
          "label": "I Love Lucy",
    ...
    },
    {
      ...
      "explanation": "Columbo made the inverted detective story its signature. The audience watches the murder and cover-up, then follows Lieutenant Columbo as he finds the discrepancy that exposes the culprit.",
      "options": [
        {
          "id": "columbo",
          "label": "Columbo",
    ...
    },
    {
      ...
      "explanation": "The Flintstones premiered on ABC in 1960 as the first animated situation comedy produced for prime time, demonstrating that television animation could attract a broad evening audience.",
      "options": [
        {
          "id": "the-flintstones",
