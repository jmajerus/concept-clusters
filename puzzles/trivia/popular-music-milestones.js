// Generated from content/puzzles/popular-music-milestones.ccpuzzle.json.
  ...
  "lenses": [
    {
      ...
      "explanation": "Michael Jackson and Quincy Jones co-produced Thriller and shared the 1984 GRAMMY for Producer of the Year, Non-Classical. The album also won Album of the Year.",
      "options": [
        {
          "id": "thriller",
    ...
    },
    {
      ...
      "explanation": "Lauryn Hill's 1999 Album of the Year victory for The Miseducation of Lauryn Hill was the first in that category for a hip-hop artist. She won five awards that night.",
      "options": [
        {
          "id": "the-miseducation",
    ...
    },
    {
      ...
      "explanation": "Kendrick Lamar won the 2018 Pulitzer Prize for Music for DAMN. The Pulitzer board described the album as a unified song collection whose stories capture the complexity of modern African American life.",
      "options": [
        {
          "id": "damn-pulitzer",
    ...
    },
    {
      ...
      "explanation": "Joni Mitchell wrote, produced, and recorded 'A Case of You' for Blue, her 1971 album. The song became one of the record's best-known explorations of intimacy and separation.",
      "options": [
        {
    ...
    },
    {
      ...
      "explanation": "Janet Jackson's Rhythm Nation 1814 produced a record-breaking seven Top 5 hits. The album itself also reached number one on the Billboard 200.",
      "options": [
        {
        ...
        },
        {
          ...
          "label": "The Rise and Fall of Ziggy Stardust",
          "targets": [
            "The Rise and Fall of Ziggy Stardust"
          ]
        },
