...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "grievance-fused-to-objective",
      "name": "Grievance Fused to Objective",
      "color": "amber",
      "fact": "A river corridor, a living space claimed for a self-declared master race, a classless agrarian utopia purged of its old cities, a national economy remade under one ethnicity's ownership -- each of these was a concrete, statable objective, and in each case the campaign against a targeted population was framed as the means of achieving it, not as an end pursued for its own sake.",
      "terms": [
        "Lebensraum",
        "Year Zero",
    ...
    },
    {
      ...
      "termInfo": {
        "Directive 7": {
          "text": "Signed by Republika Srpska president Radovan Karadžić on March 8, 1995, this directive ordered VRS troops to create 'an unbearable situation of total insecurity with no hope of further survival' for Srebrenica's and Žepa's inhabitants -- a policy outcome named without naming the killing that would produce it."
        },
        "Sonderbehandlung": {
    ...
    {
      "id": "ordinary-bureaucracy",
      "name": "Ordinary Bureaucracy",
      "color": "brown",
      "fact": "Fifteen officials over breakfast, an army corps with a chain of command, a ministry issuing telegrams province by province, neighbors organized into militia cells by local officials -- in each case, the killing was carried out as administration: assigned, scheduled, and logged by people doing a job, not by a mob.",
      "terms": [
  ...
  "bridges": [
    ...
    },
    {
      ...
      "fact": "Administrative classification and the claim that a group is less than human don't arrive in a fixed order -- Gregory Stanton's own staged model of genocide places classification before dehumanization, not after. Rwanda's Hutu-Tutsi-Twa identity cards were a Belgian colonial-era classification already six decades old when Hutu Power radio's dehumanizing broadcasts began; Nazi Germany's Nuremberg Laws, by contrast, formally classified 'Jewish' by ancestry only after antisemitic dehumanizing rhetoric had circulated in party doctrine for over a decade. Whichever comes first, once a dehumanizing claim also has a form, a stamp, and a file, ordinary bureaucrats can act on it without any one of them personally deciding who counts as human.",
      "info": {
        "text": "The administrative act of converting a category into an official, recorded classification. Whether that category was already dehumanized or became so afterward varies by case -- this board's own cases run in both directions."
      },
      "termRole": "connector",
    ...
    {
      "id": "collective-blame",
      "term": "collective blame",
      "clusters": [
        1,
        3
      ],
      "fact": "A raid, a lost war, or an unproven suspicion involved specific people -- or, in the case of a war-defeat myth, no one at all -- but the response held the whole group responsible: an entire population was blamed for what a few of its members did, or were accused of doing. The order isn't fixed here either: the stab-in-the-back myth took hold in Germany more than a decade before Nazi doctrine had fully worked out its dehumanizing vocabulary, so collective blame can build toward a dehumanizing claim as easily as it can build on one already made. Either way, treating a population as a single undifferentiated mass is what lets a disproportionate grievance scale from one incident to an entire people.",
      "info": {
        "text": "The attribution of an act, or an alleged act, to an entire group rather than to the individuals responsible for it -- an external judgment imposed on the group, not a claim about anyone's actual moral state. Closely related to dehumanization, without a fixed order between them."
      },
      "termRole": "connector",
      "relationKind": "cross-cutting"
    }
  ...
  "lenses": [
    {
      "id": "named-decisions",
      "prompt": "Which concepts are dated official documents?",
      "explanation": "Each is a specific, authored, dated record -- not a belief, an action, or an organization that spread without a single decision-maker.",
      "targets": [
        "Strategic Objective No. 3",
        "Directive 7",
        "the Tehcir Law"
      ...
      "reasons": {
        "Directive 7": "Signed by a named president.",
        "Strategic Objective No. 3": "Adopted as a formal assembly resolution.",
        "the Tehcir Law": "Passed as government legislation."
      }
    },
    {
      "id": "the-declaration",
      "prompt": "Which concepts declare a population outside human moral concern?",
      "explanation": "Four separate vocabularies making the identical underlying claim, independently, in four unconnected eras.",
      "targets": [
        "Untermenschen",
        "inyenzi",
        "harmful microbes",
      ...
      "reasons": {
        "Untermenschen": "Race science's register.",
        "genetically deformed": "Genetics' register.",
        "harmful microbes": "Medicine's register.",
        "inyenzi": "Entomology's register."
      }
    },
    {
      "id": "the-analytical-layer",
      "prompt": "Which concepts are interpretive frameworks?",
      "explanation": "Each interprets the pattern rather than reporting one genocide's own documented record.",
      "targets": [
        "pretext",
        "moral disengagement",
      ...
      "reasons": {
        "classification": "A generic administrative mechanism.",
        "collective blame": "A generic attributional mechanism.",
        "moral disengagement": "Bandura's psychological framework.",
        "pretext": "A generic mechanism, not tied to any one case.",
        "the banality of evil": "Arendt's interpretive claim about Eichmann."
      }
    },
    {
      "id": "the-declaration-at-work",
      "prompt": "Which concepts translate dehumanization into a practical instrument?",
      "explanation": "Neither claims which came first -- this board's own cases show each one preceding dehumanization in one instance and following it in another.",
      "targets": [
        "classification",
        "collective blame"
      ],
      "reasons": {
        "classification": "Turns dehumanization into an administrative record a bureaucrat can act on.",
        "collective blame": "Turns dehumanization into grounds for blaming an entire population for one incident."
      }
    }
  ],
  "relatedPuzzles": {
