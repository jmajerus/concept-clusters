...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "ethics-machinery",
      "name": "The Ethics Machinery",
      "color": "teal",
      "fact": "The 2005 PENS Task Force approved a four-part standard for psychologist participation in interrogations -- 'safe, legal, ethical, effective' -- of which only two of the criteria addressed ethics at all, while a parallel Ethics Code provision let psychologists defer to 'governing legal authority' whenever it conflicted with their own professional obligations.",
      "terms": [
        "PENS Task Force",
    ...
    },
    {
      ...
      "name": "The Collusion",
      "color": "amber",
      "fact": "Internal correspondence later showed the task force's own ethics director coordinating behind the scenes with Pentagon-affiliated members to keep the document's language vague enough not to restrict the Department of Defense, then working to suppress the ethics complaints and council motions that might have exposed it.",
      "terms": [
        "Stephen Behnke",
    ...
    },
    {
      ...
      "name": "The Reckoning",
      "color": "magenta",
      "fact": "A task force member who had raised objections from the start eventually released the entire internal correspondence archive rather than continue waiting for promised reforms, giving a small coalition of psychologists the documentation that a later independent investigation would confirm and that finally moved the association's own governing council to reverse course.",
      "terms": [
        "Jean Maria Arrigo",
        "Hoffman Report",
  ...
  "bridges": [
    {
      ...
      "fact": "Behnke's own strategy for defending the task force's report was to frame it publicly as a strong, pro-human-rights document while its actual, sidelined purpose -- affirming that psychologists could ethically continue participating in interrogations -- stayed out of view.",
      "info": {
  ...
  "lenses": [
    {
      "id": "protective-sounding-language",
      "prompt": "Which concepts are language crafted to sound like a safeguard while actually deferring or avoiding real constraint?",
      "explanation": "Each of these is language, not action: a four-part standard mostly borrowed from military instructions, a code provision that let ethics defer to authority, a repeatedly-promised clarification that never appeared, and a public framing built to obscure the guidance's real operative effect. None of them constrained anything on its own.",
      "targets": [
        "Safe, Legal, Ethical, Effective",
        "Ethics Code Standard 1.02",
        "Casebook Promise",
      ...
      "reasons": {
        "Casebook Promise": "Promising future clarification is itself a way of avoiding present constraint."
      }
    },
    {
      "id": "institutional-capture",
      "prompt": "Which concepts show a specific person or institutional relationship actively shaping the outcome toward continued participation, rather than a document or a passive default?",
      "explanation": "A director coordinating behind the scenes, the department whose preferences shaped the outcome, direct manipulation of the governing council, deliberate suppression of complaints, and a task force composition stacked before it ever met: these are active choices by specific people and institutions, not incidental features of a process.",
      "targets": [
        "Stephen Behnke",
        "Department of Defense",
        "Council Manipulation",
    ...
    {
      "id": "turning-point",
      "prompt": "Which concepts mark the specific point where internal suspicion became public, documented, and eventually binding accountability?",
      "explanation": "A released internal archive, the member who released it, the independent investigation that confirmed what it showed, and the formal vote that followed: together these four trace the exact path from private dissent to institutional reversal -- the one point in this puzzle's story where a permission-structure was actually undone rather than merely exercised.",
      "targets": [
        "PENS Listserv",
        "Jean Maria Arrigo",
        "Hoffman Report",
  ...
  "learningIntroduction": {
    ...
    "title": "Before You Begin: When Ethics Guidance Becomes Cover",
    "summary": "Context on the APA's 2005 PENS Task Force and the decade-long campaign that led to its reversal.",
    "estimatedMinutes": 4,
    "content": {
