...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "continuous-mediation",
      "name": "Continuous Mediation",
      "color": "blue",
      "fact": "In April 1915, at the height of World War I, over a thousand women from warring and neutral nations gathered at The Hague, building on the Woman's Peace Party Jane Addams had founded in Washington weeks earlier, and adopted a platform calling for continuous mediation by neutral nations as an alternative to war. The organization renamed itself the Women's International League for Peace and Freedom in 1919, and in 2000 helped secure the landmark UN resolution on Women, Peace and Security.",
      "terms": [
        "the Hague Congress",
        "Jane Addams",
    ...
    {
      "id": "moving-the-vote",
      "name": "Moving the Vote",
      "color": "amber",
      "fact": "Peace Action descends from two Cold War-era organizations that merged in 1987: SANE, founded in 1957 to oppose nuclear testing, and the Nuclear Freeze campaign, whose 1980s call to 'freeze and reverse the arms race' won endorsements from over 370 city councils and 23 state legislatures before either organization ever won a vote in Congress. The merged group, renamed Peace Action in 1993, now pursues the same insider-legitimate channels at larger scale, including an annual Congressional Voter Guide scoring every member of Congress on peace and disarmament votes.",
      "terms": [
    ...
    },
    {
      ...
      "color": "brown",
      "fact": "Founded by Philadelphia Quakers in 1917 to give conscientious objectors an alternative to military service, AFSC's WWI and WWII relief work -- including feeding a million starving children in Germany and Austria in 1919 -- won it and its British counterpart the 1947 Nobel Peace Prize. In 1955 it published Speak Truth to Power, co-authored by Bayard Rustin, and in 1963 issued Martin Luther King Jr.'s Letter from Birmingham Jail as a standalone pamphlet.",
      "terms": [
    ...
    {
      "id": "presence-as-protection",
      "name": "Presence as Protection",
      "color": "cyan",
      "fact": "Nonviolent Peaceforce, founded in 2002 after cofounder Mel Duncan pitched the idea to 9,000 fellow activists at a 1999 peace conference in the Hague, deploys unarmed, paid Protection Officers directly into active conflict zones -- South Sudan, Myanmar, Ukraine, Syria -- on the premise that a trained, nonpartisan presence can deter violence and protect civilians without carrying a weapon.",
      "terms": [
  ...
  "bridges": [
    {
      ...
      "fact": "Both organizations put their WWI-era pacifism into direct practice through relief rather than only protest: WILPF women served as European relief workers resettling refugees, while AFSC fed a million starving children in the defeated nations of Germany and Austria in 1919 -- treating aid to a former enemy's civilians as itself an act of peacemaking.",
      "info": {
  ...
  "lenses": [
    {
      "id": "named-texts-and-treaties",
      "prompt": "Which concepts are a specific written text or signed agreement, rather than an organization, program, or ongoing practice?",
      "explanation": "Each of these is a specific written text or signed agreement that can be read, cited, and pointed to directly -- unlike an organization, a program, or an ongoing practice. 'The Woman's Peace Party' and 'SANE' are organizations; 'Unarmed Civilian Protection' is a method, not a document.",
      "targets": [
        "Speak Truth to Power",
        "Letter from Birmingham Jail",
    ...
    {
      "id": "insider-access-to-power",
      "prompt": "Which concepts represent working through an existing, formally recognized channel of power -- a treaty process, a legislature, or an international prize -- rather than direct field presence or grassroots mobilization?",
      "explanation": "A Security Council resolution, a congressional scorecard, a Nobel Peace Prize, and a negotiated international treaty are each a formally recognized channel of an existing power structure -- the UN, Congress, the Nobel committee, or treaty diplomacy. Notably, none of Nonviolent Peaceforce's own terms appear here: unlike the other three organizations, its theory of change runs through direct field presence, not through petitioning an existing seat of power.",
      "targets": [
        "Women, Peace and Security",
        "the Congressional Voter Guide",
        "the 1947 Nobel Peace Prize",
    ...
    {
      "id": "direct-local-practice",
      "prompt": "Which concepts represent working directly with communities or individuals, rather than through a formal seat of power?",
      "explanation": "Where the previous lens ran through formal seats of power, these three run through direct, unmediated relationships with ordinary people instead: a local council resolution, a community-based protection partnership, and feeding a defeated nation's own children. None of them requires an invitation from an existing institution.",
      "targets": [
        "civilian-to-civilian action",
        "ballot-initiative organizing",
        "postwar relief work"
  ...
  "learningIntroduction": {
    ...
    "title": "Before You Begin: A Different Theory of Change",
    "summary": "Context on four peace organizations built around diplomacy, legislation, relief work, and unarmed field presence.",
    "estimatedMinutes": 5,
    "content": {
