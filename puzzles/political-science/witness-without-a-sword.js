...
export default definePuzzle(import.meta.url, {
  ...
  "clusters": [
    {
      "id": "icrc-witness",
      "name": "Breaking Its Own Silence",
      "color": "blue",
      "fact": "The ICRC's public voice has grown louder, and not by choice: in 2025 alone, at least 31 staff and volunteers of the Red Cross and Red Crescent Movement were killed in the course of their work. An organization built on quiet, confidential access finds it harder to stay quiet when its own people are the ones being buried.",
      "terms": [
    ...
    },
    {
      ...
      "color": "magenta",
      "fact": "MSF's founders were originally Red Cross volunteers who broke from its policy of discretion after witnessing atrocities in Biafra they felt could not go unspoken. That founding choice still shapes the organization: funded almost entirely by private donors rather than governments, and willing to name a violation -- or walk away from a mission -- rather than stay silent about one.",
      "terms": [
        "témoignage",
  ...
  "lenses": [
    {
      "id": "pressure-without-a-verdict",
      "prompt": "Which concepts are individual acts of leverage -- a conversation, a post, a founding commitment to speak -- exercised directly by an organization itself, rather than a sustained, named institutional campaign or publication?",
      "explanation": "The Global IHL Initiative, Medical Care Under Fire, and annual reporting are all real leverage too -- but each is a sustained, named institutional campaign or publication, distinct from the direct, moment-to-moment act of talking or posting.",
      "targets": [
        "confidential bilateral dialogue",
        "social media campaigning",
        "témoignage"
      ...
      "reasons": {
        "confidential bilateral dialogue": "A direct, private conversation with a belligerent -- no institution required beyond the conversation itself.",
        "témoignage": "A founding commitment to speak, not a program built up over years."
      }
    },
    {
      "id": "named-instruments",
      "prompt": "Which concepts are a specific, named campaign, publication, resolution, or institution -- something with its own identity you could look up directly -- rather than a general method, principle, or structural condition?",
      "explanation": "Each of these is a specific thing with its own name and history -- a diplomatic coalition, an awareness campaign, a data system, a founding treaty, two separate Security Council resolutions. Témoignage, financial independence, confidential bilateral dialogue, and neutral intermediary are all real and important, but they're general methods or conditions, not named things you could look up on their own.",
      "targets": [
        "the Global IHL Initiative",
        "Medical Care Under Fire",
        "the Rome Statute",
      ...
      "reasons": {
        "Resolution 2286": "A single, specific Security Council resolution on protecting medical and humanitarian personnel, adopted in 2016.",
        "Resolution 2730": "A separate, later Security Council resolution on the same underlying problem, adopted in 2024.",
        "the WHO Surveillance System": "A named, standardized data system with its own launch date and methodology."
      }
    }
  ],
  "learningIntroduction": {
    "requirement": "recommended",
    "title": "Evidence, Access, and a Voice",
    "summary": "Why the organizations tracking violations of the rules of war can't compel anyone to follow them.",
    "estimatedMinutes": 3,
    "content": {
